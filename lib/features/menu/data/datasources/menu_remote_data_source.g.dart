...
part of 'menu_remote_data_source.dart';
...
class _MenuRemoteDataSource implements MenuRemoteDataSource {
  _MenuRemoteDataSource(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  }) {
  ...
  @override
  Future<List<ProductModel>> getProducts(Map<String, dynamic> queries) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
